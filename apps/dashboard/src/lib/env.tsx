...
const _inlineEnvVars = {
  ...
  NEXT_PUBLIC_STACK_SESSION_REPLAYS_ENABLED: process.env.NEXT_PUBLIC_STACK_SESSION_REPLAYS_ENABLED,
...
const _postBuildEnvVars = {
  ...
  NEXT_PUBLIC_STACK_SESSION_REPLAYS_ENABLED: "STACK_ENV_VAR_SENTINEL_NEXT_PUBLIC_STACK_SESSION_REPLAYS_ENABLED",
