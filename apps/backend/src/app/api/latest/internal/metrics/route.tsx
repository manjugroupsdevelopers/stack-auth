...
import { getPrismaClientForTenancy, getPrismaSchemaForTenancy, PrismaClientTransaction, sqlQuoteIdent } from "@/prisma-client";
...
async function loadUsersByCountry(tenancy: Tenancy, prisma: PrismaClientTransaction, includeAnonymous: boolean = false): Promise<Record<string, number>> {
  try {
    ...
    // ClickHouse is optional, return empty data if not available
    return {};
  }
}
